...
image1 = pipe(prompt=public_prompt, num_inference_steps=total_step, guidance_scale=public_scale, common_step=common_step, prompt_unchanged=True, generator=generator).images[0]
image1.save("1-1.png")  # public prompt

positive_personal_prompt = positive_personal_prompts[0]
negative_personal_prompt = negative_personal_prompts[0]
image2 = pipe(prompt=positive_personal_prompt, num_inference_steps=total_step, guidance_scale=personal_scale, common_step=common_step, prompt_unchanged=False, generator=generator).images[0]
image2.save("2-1.png")  # positive personal prompt
image3 = pipe(prompt=positive_personal_prompt, negative_prompt=negative_personal_prompt, num_inference_steps=total_step, guidance_scale=personal_scale, common_step=common_step, prompt_unchanged=False, generator=generator).images[0]
image3.save("2-2.png")  # (positive + negative) personal prompt

image4 = pipe(prompt=negative_personal_prompt, num_inference_steps=total_step, guidance_scale=personal_scale, common_step=common_step, prompt_unchanged=False, generator=generator).images[0]
image4.save("3-1.png")  # negative personal prompt
image5 = pipe(prompt=positive_personal_prompt, num_inference_steps=total_step - common_step, guidance_scale=8.0, common_step=0, generator=generator).images[0]
image5.save("3-2.png")  # traditional offloading scheme
