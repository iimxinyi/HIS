...
image2 = pipe(prompt=positive_personal_prompt, negative_prompt=negative_personal_prompt, num_inference_steps=total_step, guidance_scale=personal_scale, common_step=common_step, prompt_unchanged=False, generator=generator).images[0]
image2.save("2-1.png")  # (positive + negative) personal prompt

image3 = pipe(prompt=positive_personal_prompt, num_inference_steps=total_step, guidance_scale=personal_scale, common_step=common_step, prompt_unchanged=False, generator=generator).images[0]
image3.save("2-2.png")  # positive personal prompt
...
image4.save("2-3.png")  # negative personal prompt