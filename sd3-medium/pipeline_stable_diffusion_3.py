    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                #     flops = FlopCountAnalysis(self.transformer, transformer_inputs)
                #     print(flops.total())
                #     print(parameter_count_table(self.transformer))
                ...
                # get intermediate results every timestep
                if get_intermediate_result == True:
                    latents_immediate = latents
                    latents_immediate = (latents / self.vae.config.scaling_factor) + self.vae.config.shift_factor
                    image = self.vae.decode(latents_immediate, return_dict=False)[0]
