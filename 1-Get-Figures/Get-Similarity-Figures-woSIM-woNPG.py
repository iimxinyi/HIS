...
for index1, public_prompt in enumerate(positive_prompts):
    for index2, personal_prompt in enumerate(positive_prompts):
        for common_step in range(0,28):
            ...
            image2 = pipe(prompt=personal_prompt, num_inference_steps=total_step, guidance_scale=personal_scale, common_step=common_step, prompt_unchanged=False, generator=generator).images[0]
