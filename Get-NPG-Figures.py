...
for j in range(0,20):
    for seed in range (1,10):
        ...
        file_path2 = os.path.join(results_dir2, f"prompt{j}_seed{seed}_wNPG.png")
        file_path3 = os.path.join(results_dir3, f"prompt{j}_seed{seed}_woNPG.png")
